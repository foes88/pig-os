...
const T: Record<string, Record<string, string>> = {
  ...
  ru: { back: "К монитору", sows: "Свиноматки", psy: "PSY (год)", weaned: "Отъём за год", avgSows: "Ср. маток", status: "Статус маток", events: "Активность", type: "Тип", total: "Всего", d30: "30д", last: "Последний", recent: "Недавняя активность", none: "Нет активности", loading: "Загрузка…", org: "Орг", country: "Страна", quality: "Качество данных", litter: "Несовпадение помёта", reversal: "Инверсия дат", orphan: "Сирота статуса", clean: "Без проблем" },
};
