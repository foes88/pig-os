...
const T: Record<string, {
  ...
  ru: { title: "Затраты · Доход", sub: "Затраты на корм (введённые) и выручка от продаж, по валютам.", feedCost: "Затраты на корм", revenue: "Выручка", net: "Чистая", coverage: "Полнота затрат", period: "Период", currency: "Валюта", feedQty: "Корм (кг)", saleHead: "Продано (гол.)", noData: "Нет данных о корме или продажах за период.", selectFarm: "Выберите ферму.", coverageNote: "В затраты входят только записи корма с указанной ценой. Чистая прибыль исключает корм без указанной цены.", p6m: "6 мес", p1y: "1 год", p2y: "2 года" },
};
