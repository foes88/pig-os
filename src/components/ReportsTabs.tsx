...
const TABS = [
  ...
  { href: "/reports/trend",              label: { en: "Trend", ko: "연도추세", zh: "年度趋势", es: "Tendencia", vi: "Xu hướng" } },
  { href: "/reports/monthly",            label: { en: "Monthly", ko: "월별종합", zh: "月度综合", es: "Mensual", vi: "Hàng tháng" } },
