...
> ※ **개인정보 보호책임자 확정(2026-08-25, 대표 확인)**: 성명 **진교문(Grant Jin)** · 직위 **대표이사(CEO)** · 담당부서 **경영지원팀** · 연락처 `wiselake@wiselake.ai` / +82-31-421-3418.
>   → NOTICE 제1조(국문·영문) 기입 완료. iOS 앱 개인정보처리방침 12절에도 동일 반영.
